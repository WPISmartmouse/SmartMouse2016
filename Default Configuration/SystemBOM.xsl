      ...
      <BODY>
        <TABLE style="font:8pt Segoe UI" border="1" CELLSPACING="0" CELLPADDING="1" BGCOLOR="#FFFFFF">
          ...
          <TR valign="top">
            ...
            <TD align="left">
              <xsl:value-of select="@Alternate_Manufacturer"/>
              <xsl:if test="@Alternate_Manufacturer[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@Alternate_PartNumber"/>
              <xsl:if test="@Alternate_PartNumber[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@MountType"/>
              <xsl:if test="@MountType[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@PageSetup"/>
              <xsl:if test="@PageSetup[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@SymbolCreator"/>
              <xsl:if test="@SymbolCreator[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
              <xsl:value-of select="@SymbolVersion"/>
              <xsl:if test="@SymbolVersion[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
            ...
            <TD align="left">
              <xsl:value-of select="@U_M"/>
              <xsl:if test="@U_M[.='']">&#160;</xsl:if>
            </TD>
            <TD align="left">
